...
def charger_pet():
    if os.path.exists(DATA_FILE):
        with open(DATA_FILE, "r") as f:
            return json.load(f)
    return {"name": "Luna", "hunger": 50, "happiness": 50, "energy": 100, "last_update": time.time()}
...
def delete_pet():
    default_state = {"name": "Luna", "hunger": 50, "happiness": 50, "energy": 100, "last_update": time.time()}
